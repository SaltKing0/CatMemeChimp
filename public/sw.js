const VERSION = 'memechimp-v8';
const CORE = ['/', '/index.html', '/app.js', '/lib/state.mjs', '/lib/pack.mjs', '/style.css', '/fonts.css', '/library.json', '/manifest.webmanifest', '/assets/chimp.svg', '/assets/biscuit.png'];
