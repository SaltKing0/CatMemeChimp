...
The 10 `general-*.svg` files in `public/assets/memes/` are original MemeChimp artwork, covered by this repository's MIT license. General entries in `public/library.json` use `"source": null`.
