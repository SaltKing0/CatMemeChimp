...
- 100 curated caption remixes (60 cat + 40 general) using 31 community templates plus 10 original MemeChimp SVG templates, with individual source links. Entries carry `category: cat` or `general`.
...
The 100 captions were written for MEMECHIMP. Cat images are community meme templates sourced from Imgflip; every cat record in **public/library.json** retains its source page. The 10 `general-*.svg` templates are original MemeChimp artwork (MIT). No license or ownership of third-party source imagery is asserted. Collection date: September 8, 2026; general set added September 25, 2026. This is a curated collection, not a live feed. See [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md) before redistributing media.
