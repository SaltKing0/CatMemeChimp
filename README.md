...
- 100 curated caption remixes (60 cat + 40 general) using 31 community templates plus 10 Wikimedia Commons CC photos, with individual source links. Entries carry `category: cat` or `general`.
