...
- 60 curated caption remixes using 31 locally downloaded community templates, with individual source links. Each entry carries `category: cat` today and `general` tomorrow.
